...
type LoanGuarantor struct {
	...
	Status           GuarantorStatus        `protobuf:"varint,4,opt,name=status,proto3,enum=loan.v1.GuarantorStatus" json:"status,omitempty"`
...
type CreditBalance struct {
	...
	Status         CreditStatus           `protobuf:"varint,6,opt,name=status,proto3,enum=loan.v1.CreditStatus" json:"status,omitempty"`
	CreatedAt      *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
...
func (x *ApplyForLoanRequest) GetOfficerId() string {
	if x != nil {
		return x.OfficerId
	}
	return ""
...
type ApplyForLoanResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	LoanId        string                 `protobuf:"bytes,1,opt,name=loan_id,json=loanId,proto3" json:"loan_id,omitempty"`
	Status        LoanStatus             `protobuf:"varint,2,opt,name=status,proto3,enum=loan.v1.LoanStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ApproveLoanRequest) GetOfficerId() string {
	if x != nil {
		return x.OfficerId
	}
	return ""
...
type ApproveLoanResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NewStatus     LoanStatus             `protobuf:"varint,1,opt,name=new_status,json=newStatus,proto3,enum=loan.v1.LoanStatus" json:"new_status,omitempty"`
...
type RejectLoanRequest struct {
	...
	LoanId        string                 `protobuf:"bytes,1,opt,name=loan_id,json=loanId,proto3" json:"loan_id,omitempty"`
	Reason        string                 `protobuf:"bytes,2,opt,name=reason,proto3" json:"reason,omitempty"`
	LoanOfficer   string                 `protobuf:"bytes,3,opt,name=loan_officer,json=loanOfficer,proto3" json:"loan_officer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RejectLoanRequest) GetLoanOfficer() string {
	if x != nil {
		return x.LoanOfficer
	}
	return ""
}
...
func (x *DisburseLoanRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *DisburseLoanRequest) GetLoanOfficer() string {
	if x != nil {
		return x.LoanOfficer
	}
	return ""
...
type GetLoanStatusResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Status         LoanStatus             `protobuf:"varint,1,opt,name=status,proto3,enum=loan.v1.LoanStatus" json:"status,omitempty"`
...
type AddGuarantorResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        GuarantorStatus        `protobuf:"varint,1,opt,name=status,proto3,enum=loan.v1.GuarantorStatus" json:"status,omitempty"`
...
type ApproveGuarantorResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	NewStatus     GuarantorStatus        `protobuf:"varint,1,opt,name=new_status,json=newStatus,proto3,enum=loan.v1.GuarantorStatus" json:"new_status,omitempty"`
	ApprovedAt    *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=approved_at,json=approvedAt,proto3" json:"approved_at,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_loan_v1_loan_proto_rawDesc = "" +
	...
	"\x17repayment_period_months\x18\x06 \x01(\x05R\x15repaymentPeriodMonths\x12+\n" +
	"\x06status\x18\a \x01(\x0e2\x13.loan.v1.LoanStatusR\x06status\x12=\n" +
	...
	"\x11guaranteed_amount\x18\x03 \x01(\tR\x10guaranteedAmount\x120\n" +
	"\x06status\x18\x04 \x01(\x0e2\x18.loan.v1.GuarantorStatusR\x06status\x12;\n" +
	"\vapproved_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"approvedAt\x12\x1f\n" +
	"\vapproved_by\x18\x06 \x01(\tR\n" +
	"approvedBy\x129\n" +
	"\n" +
	"created_at\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xb5\x02\n" +
	...
	"\n" +
	"officer_id\x18\x03 \x01(\tR\tofficerId\"\x86\x01\n" +
	"\x13ApproveLoanResponse\x122\n" +
	"\n" +
	...
	"\floan_officer\x18\x03 \x01(\tR\vloanOfficer\"\x85\x01\n" +
	"\x12RejectLoanResponse\x122\n" +
	"\n" +
	"new_status\x18\x01 \x01(\x0e2\x13.loan.v1.LoanStatusR\tnewStatus\x12;\n" +
	...
	"\aloan_id\x18\x01 \x01(\tR\x06loanId\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12!\n" +
	"\floan_officer\x18\x03 \x01(\tR\vloanOfficer\"\xac\x01\n" +
	"\x14DisburseLoanResponse\x122\n" +
	"\n" +
	"new_status\x18\x01 \x01(\x0e2\x13.loan.v1.LoanStatusR\tnewStatus\x12=\n" +
	...
	"\aloan_id\x18\x01 \x01(\tR\x06loanId\"\xac\x01\n" +
	"\x15GetLoanStatusResponse\x12+\n" +
	"\x06status\x18\x01 \x01(\x0e2\x13.loan.v1.LoanStatusR\x06status\x12'\n" +
	...
	"\aloan_id\x18\x01 \x01(\tR\x06loanId\x12!\n" +
	"\fguarantor_id\x18\x02 \x01(\tR\vguarantorId\x12+\n" +
	"\x11guaranteed_amount\x18\x03 \x01(\tR\x10guaranteedAmount\"\x83\x01\n" +
	"\x14AddGuarantorResponse\x120\n" +
	"\x06status\x18\x01 \x01(\x0e2\x18.loan.v1.GuarantorStatusR\x06status\x129\n" +
	"\n" +
	...
	"approvedBy\"\x90\x01\n" +
	"\x18ApproveGuarantorResponse\x127\n" +
	"\n" +
	"new_status\x18\x01 \x01(\x0e2\x18.loan.v1.GuarantorStatusR\tnewStatus\x12;\n" +
	"\vapproved_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"approvedAt\"l\n" +
	...
	"\x16ListGuarantorsResponse\x126\n" +
	"\n" +
	"guarantors\x18\x01 \x03(\v2\x16.loan.v1.LoanGuarantorR\n" +
	"guarantors\x12&\n" +
...
var file_loan_v1_loan_proto_goTypes = []any{
	...
	(CreditStatus)(0),                // 2: loan.v1.CreditStatus
