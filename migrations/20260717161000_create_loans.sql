...
CREATE TABLE loans (
    ...
    collateral_coverage_ratio NUMERIC(19,8) NOT NULL,
    ...
    CONSTRAINT chk_loans_collateral_value_non_negative CHECK (collateral_value >= 0),
    CONSTRAINT chk_loans_collateral_coverage_ratio_non_negative CHECK (collateral_coverage_ratio >= 0),
    CONSTRAINT chk_loans_collateral_coverage CHECK (collateral_value >= (principal * 0.5)),
